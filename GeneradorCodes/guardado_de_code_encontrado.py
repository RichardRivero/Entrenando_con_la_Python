...
# hay que realizar una convercion a str para que pueda
# ser ejecutado por el programa y guardar los archivos 
# es importante hacer la combercion ,  no soporta el
# uso de variables tipo int ni arreglos como tuplas o listas 
